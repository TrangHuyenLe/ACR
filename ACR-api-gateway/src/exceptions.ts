...
export class FalsyValueError extends SafeError {
  value;
  path: string;
  ...
  toBaseResponse() {
    return new BaseResponse()
      .failed({ message: this.message, value: this.value })
      .m(this.message);
  }
}
...
export class RequireLengthFailed extends SafeError {
  ...
  toBaseResponse() {
    return new BaseResponse()
      .failed({ input: this.input, comparator: this.comparator })
      .m(this.message);
  }
}
...
export class RequireMatchFailed extends SafeError {
  ...
  toBaseResponse() {
    return new BaseResponse()
      .failed({ input: this.input, regex: this.regex })
      .m(this.message);
  }
}
...
export class TypeMismatchError extends SafeError {
  ...
  toBaseResponse() {
    return new BaseResponse()
      .failed({ path: this.path, value: this.value, type: this.type })
      .m(this.message);
  }
}
